...
function authenticateJWT(req, res, next) {
  console.log(" for authorization : checking JWT for:", req.method, req.originalUrl);
...
app.get('/books', authenticateJWT, checkRole('books'), createProxyMiddleware({
...
// Authors service
app.use('/authors', checkRole('authors'), createProxyMiddleware({
  target: 'http://localhost:3002',
  changeOrigin: true
}));

// Categories service
app.use('/categories', checkRole('categories'), createProxyMiddleware({
