...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (editBookData) {
    ...
    (document.getElementById('isbn') as HTMLInputElement).value = book.isbn.toString();
    ...
    (document.getElementById('book-type') as HTMLSelectElement).value = book.bookType;
  }
});
...
form.addEventListener('submit', (e) => {
  ...
  const book: BookData = {
    ...
    bookType: (document.getElementById('book-type') as HTMLSelectElement).value as 'ebook' | 'printed'
  };
